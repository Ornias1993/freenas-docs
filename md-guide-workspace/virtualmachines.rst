...
.. table:: VM Wizard Options
   ...
   |          |                    |                | prevent VMs from running. This is a :ref:`humanized field <Humanized Fields>`.                                                   |
   +----------+--------------------+----------------+-----------------------------------------------------------------------------------------------+
   ...
   +----------+--------------------+----------------+-----------------------------------------------------------------------------------------------+
   | 3        | Size (Examples:    |                | Allocate the amount of storage for the zvol. This is a :ref:`humanized field <Humanized Fields>`.                                |
...
and click :guilabel:`ADD` to add a new VM device.
...
going to
:menuselection:`Virtual Machines -->` ui-options :menuselection:`--> Devices`,
clicking :guilabel:`ADD`, and selecting :guilabel:`NIC` as the
:guilabel:`Type`.
...
by clicking
:menuselection:`Virtual Machines -->` ui-options :menuselection:`--> Devices`,
clicking :guilabel:`ADD`, and selecting :guilabel:`Disk` as the
:guilabel:`Type`.
...
click
:menuselection:`Virtual Machines -->` ui-options :menuselection:`--> Devices`,
click :guilabel:`ADD`, then set the :guilabel:`Type` to :guilabel:`Raw File`.

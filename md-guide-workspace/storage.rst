...
and click :guilabel:`ADD`. Select :guilabel:`Create new pool` and click
...
* FreeNAS\ :sup:`®` encryption differs from the encryption used in the Oracle
...
:samp:`zpool export {poolname}` command or a web interface equivalent to
...
:menuselection:`Storage --> Pools`
and :guilabel:`ADD`. Select :guilabel:`Import an existing pool`, then click

...
The FreeNAS\ :sup:`®` web interface supports dynamically changing the active theme and
...
.. table:: General Options for a New Theme
   ...
   |                   | menu         | primary theme color. The primary color changes the top bar of the web interface               |
...
FreeNAS\ :sup:`®` web interface. Activating :guilabel:`Global Preview` allows going

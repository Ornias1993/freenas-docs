...
<td>string</td>
<td>If <em>Command</em> is selected, enter the command with any options. When <em>Script</em> is selected, click ui-browse to select the script from an existing pool.</td>
</tr>
<tr class="odd">
<td>When</td>
<td>drop-down menu</td>

...
The :guilabel:`ADD` button opens the screen shown in
...
.. table:: User Account Configuration
   ...
   +----------------------------+-----------------+-------------------------------------------------------------------------------------------------------------------------------+
   | Shell                      | drop-down menu  | Select the shell to use for local and SSH logins. The *root* user shell is used for web interface :ref:`Shell` sessions. See       |

...
* **Module:** exports a directory tree, and the configured
  ...
  server. It can be defined in the FreeNAS\ :sup:`®` |web-ui| under
...
datasets for snapshot and replication as |rpln-sys1| and the FreeNAS\ :sup:`®`
...
In the FreeNAS\ :sup:`®` |web-ui|, go to
